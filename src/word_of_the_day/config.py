...
class Settings(BaseSettings):
    ...
    poetry_db_base_url: str = Field(default="https://poetrydb.org", validation_alias="POETRY_DB_BASE_URL")
    quotable_base_url: str = Field(default="https://api.quotable.io", validation_alias="QUOTABLE_BASE_URL")
    ...
    wikipedia_version: str | None = Field(default=None, validation_alias="WIKIPEDIA_VERSION")

    poetry_db_app_name: str | None = Field(default=None, validation_alias="POETRY_DB_APP_NAME")
    poetry_db_contact_email: str | None = Field(default=None, validation_alias="POETRY_DB_CONTACT_EMAIL")
    poetry_db_version: str | None = Field(default=None, validation_alias="POETRY_DB_VERSION")
    ...
    seed_csv_path: str = Field(default="word_of_the_day_embeddings.csv", validation_alias="SEED_CSV_PATH")
    cache_npz_path: str = Field(default="word_of_the_day_embeddings.npz", validation_alias="CACHE_NPZ_PATH")

    # Substack configuration
    substack_category: str = Field(default="philosophy", validation_alias="SUBSTACK_CATEGORY")
    substack_limit_pubs: int = Field(default=3, validation_alias="SUBSTACK_LIMIT_PUBS")
    substack_limit_posts: int = Field(default=3, validation_alias="SUBSTACK_LIMIT_POSTS")
